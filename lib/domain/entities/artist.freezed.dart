...
mixin _$Artist {
  ...
  @override
  String toString() {
    return 'Artist(id: $id, name: $name, imageUrl: $imageUrl, bio: $bio)';
  }
}
...
abstract mixin class $ArtistCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String name, String? imageUrl, String? bio});
}
...
extension ArtistPatterns on Artist {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String id, String name, String? imageUrl, String? bio)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _Artist() when $default != null:
        return $default(_that.id, _that.name, _that.imageUrl, _that.bio);
      case _:
        return orElse();
    }
  }
...
class _Artist implements Artist {
  const _Artist(
      {required this.id, required this.name, this.imageUrl, this.bio});
